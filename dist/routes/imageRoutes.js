...
const handleImageNotFoundError = (req, res, next) => {
    const imagePath = path_1.default.join(__dirname, "../public/uploads/imgtickets", req.url);
...
router.use("/", handleImageNotFoundError, express_2.default.static(path_1.default.join(__dirname, "../public/uploads/imgtickets")));
