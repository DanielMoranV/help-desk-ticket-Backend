...
-- CreateTable
CREATE TABLE "TickePhoto" (
    "photo_id" SERIAL NOT NULL,
    "ticket_id" INTEGER NOT NULL,
    "filename" TEXT NOT NULL,

    CONSTRAINT "TickePhoto_pkey" PRIMARY KEY ("photo_id")
);
...
-- AddForeignKey
ALTER TABLE "TickePhoto" ADD CONSTRAINT "TickePhoto_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES "ticket"("ticket_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ticket_comment" ADD CONSTRAINT "ticket_comment_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES "ticket"("ticket_id") ON DELETE RESTRICT ON UPDATE CASCADE;
